...
class TripSchema(Schema):
    ...
    km_rate = fields.Float(allow_none=True, validate=validate.Range(min=0))
    calculation_type = fields.String(allow_none=True, validate=validate.OneOf(['by_tonnage', 'by_km', 'both']))
